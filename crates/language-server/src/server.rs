...
use async_lsp::lsp_types::request::{DocumentHighlightRequest, GotoDefinition, GotoTypeDefinition, HoverRequest, References, Shutdown};
...
use crate::functionality::{goto, handlers, highlight, references, type_definition};
